...
urlpatterns = [
    ...
    path('notifications/', permission_required('home.view_notifications',
    login_url='/home/access_denied/')(views.notifications_view), name='notifications'),
    ...
    path('ajax/get_notifications_count', views.get_active_notifications,
