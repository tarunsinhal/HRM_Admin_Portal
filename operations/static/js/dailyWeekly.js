...
function editfunction(obj) {
	...
	z[0].value = x[4].textContent;
	document.getElementById('editForm').action = obj.id;

}

// function recheckfunction(obj) {
// 	debugger
// 	document.getElementById('exampleModalLabel').textContent = 'Update';
// 	document.getElementById('modal-body').textContent = 'Are you sure you want to update this product?';
// 	document.getElementById('modal-btn2').textContent = 'Update';
...
function repeatfunction(obj, obj2) {
	...
	for (var i, j = 0; i = mySelect[1].options[j]; j++) {
		if (unit == i.value) {
			...
			mySelect[1].style.pointerEvents = 'none';
			break;
		}
	}
...
$('#modal-btn2').on('click', handleEditProduct)