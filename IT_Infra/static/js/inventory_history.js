function format ( d ) {
	...
	'<div class="row"><div class="col-3"><span class="font-weight-bold">Allottee Id: </span>'+d[7]+'</div></div><br>'+
        '<div class="row"><div class="col-6"><span class="font-weight-bold">Allottee Name: </span>'+d[8]+'</div></div><br>'+
		'<div class="row"><div class="col-6"><span class="font-weight-bold">Remarks: </span>'+d[9]+'</div></div><br>'+
        '</div></div>';
}
