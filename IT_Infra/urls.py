...
urlpatterns = [
    ...
    path('inventory/discard/<str:pk>',permission_required('IT_Infra.view_it_inventory', login_url='/home/access_denied/')(views.discard_inventory_item) , name="discardInventory"),
    path('inventory/Hardwareimport', permission_required('IT_Infra.view_it_inventory', login_url='/home/access_denied/')(views.ImportHardwareInventoryView.as_view()) , name='import_hardware_inventory'),
    path('inventory/Softwareimport',permission_required('IT_Infra.view_it_inventory', login_url='/home/access_denied/')(views.ImportSoftwareInventoryView.as_view()) , name='import_software_inventory'),
    ...
    path('inventory/deleted_inventory_history',permission_required('IT_Infra.view_it_inventory', login_url='/home/access_denied/')(views.deleted_inventory_history) , name='deleted_inventory_history'),
    ...
    path('ajax/load_data',permission_required('IT_Infra.view_it_allotment', login_url='/home/access_denied/')(views.load_data) , name="ajax_load_data"),
    path('ajax/load_employee_names', permission_required('IT_Infra.view_it_allotment', login_url='/home/access_denied/')(views.load_employee_names) , name="ajax_load_employee_names"),
    path('ajax/load_item_data', permission_required('IT_Infra.view_it_allotment', login_url='/home/access_denied/')(views.load_item_data), name="ajax_load_item_data"),
    path('ajax/load_item_name', permission_required('IT_Infra.view_it_allotment', login_url='/home/access_denied/')(views.load_item_name), name="ajax_load_item_name"),
    path('ajax/load_item_details',permission_required('IT_Infra.view_it_allotment', login_url='/home/access_denied/')(views.load_item_details) , name="ajax_load_item_details"),
    ...
    path('ajax/load_edit_damage_images',permission_required('IT_Infra.view_it_allotment', login_url='/home/access_denied/')(views.load_edit_images), name='ajax_edit_damage_images')
] 
